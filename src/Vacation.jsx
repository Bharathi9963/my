...
function Project(){
    ...
    function readmore(ind){
        var readmor=document.getElementById('dd')
        if(readmor.innerHTML==='....Read more'){
            readmor.innerHTML='....Read less'
        }
        else{
            readmor.innerHTML='....Read more'
        }
        ...
        tour.map((place,i)=>{
            ...
            <div class="card" style={{width:"40%",height:"auto",marginBottom:"30px"}}>
             ...
             <div class="card-body" style={{width:"auto",padding:"5px"}}>
                 ...
                 <span onClick={()=>{readmore(i)}} id='dd' style={{color:'Red'}}>....Read more</span></p>
